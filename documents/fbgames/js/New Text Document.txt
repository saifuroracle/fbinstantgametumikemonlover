    ...
    function m() {
        ...
        function p(a) {
            var b = r(a, "border-left-width"),
                ...
                console.log("=====Function p start ======");
                console.log(a.scrollWidth);
                console.log("=====Function p end ======");
            return 1023; //a.scrollWidth + b + c
        }

        function q(a) {
            var b = r(a, "border-top-width"),
                c = r(a, "border-bottom-width");
            console.log("=====Function q start ======");
            console.log(a.scrollHeight);
            console.log("=====Function q end ======");
            return 1300; //a.scrollHeight + b + c
        }
